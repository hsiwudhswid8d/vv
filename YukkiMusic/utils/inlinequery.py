...
answer.extend(
    [
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent("ميرا طفيها"),
        ),
        InlineQueryResultArticle(
            title="تكرار التشغيل",
